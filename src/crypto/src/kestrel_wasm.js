...
* @returns {Uint8Array}
*/
export function chapoly_encrypt_ietf(key, nonce, plaintext, aad) {
    try {
        ...
        wasm.chapoly_encrypt_ietf(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
...
* @returns {Uint8Array}
*/
export function chapoly_decrypt_ietf(key, nonce, ciphertext, aad) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ptr3 = passArray8ToWasm0(aad, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        wasm.chapoly_decrypt_ietf(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function pass_encrypt(plaintext, password, salt, file_format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len2 = WASM_VECTOR_LEN;
        wasm.pass_encrypt(retptr, ptr0, len0, ptr1, len1, ptr2, len2, file_format);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {Uint8Array}
*/
export function pass_decrypt(ciphertext, password, file_format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.pass_decrypt(retptr, ptr0, len0, ptr1, len1, file_format);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export function x25519(k, u) {
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.x25519(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1, 1);
...
* @returns {Uint8Array}
*/
export function x25519_derive_public(private_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.x25519_derive_public(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function scrypt(password, salt, n, r, p, dk_len) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.scrypt(retptr, ptr0, len0, ptr1, len1, n, r, p, dk_len);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1, 1);
